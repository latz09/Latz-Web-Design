		...
		<div className="relative pt-24 pb-32 max-w-5xl mx-auto px-4 overflow-hidden">
			...
			<div className="absolute inset-0 flex justify-center items-center pointer-events-none">
				<Image
					src={savingImage}
					alt="No Monthly Fees"
					className="opacity-10 w-full h-auto max-w-[500px] object-contain "
				/>
			</div>
			...
			<div className="relative z-10 space-y-4 text-center">
				...
				<Description
					description="Some web companies keep charging you every month just to keep your site online. Not here. We build it, you own it — no subscriptions, no surprise fees, no ongoing costs. Just a one-time investment in your business."
				/>
			</div>
		</div>
	);
