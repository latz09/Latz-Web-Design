...
const ChatPointer = () => {
    ...
    return (
        <motion.div
            className="fixed bottom-5 right-20 bg-light border border-primary/30 text-primary px-3 py-2 rounded-full shadow-lg z-[999999] flex items-center gap-3 tracking-wider  text-xs font-bold 2xl:text-base "
            initial="hidden"
