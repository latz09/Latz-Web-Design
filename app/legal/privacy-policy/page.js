...
const businessName = 'Latz Web Design';
const contactEmail = 'jordan@latzwebdesign.com';
const effectiveDate = 'January 1, 2024';

const PrivacyPolicy = () => {
	return (
		<div className="bg-light pt-32">
			<div className='flex justify-center items-center  bg-light  py-12'>
				<div className='max-w-4xl bg-white p-6 lg:p-12 rounded-sm shadow-lg bg-primary/5'>
					...
					<ul className='list-disc list-inside mb-4'>
						<li>
							...
							number, and any other contact information you provide when you
							fill out contact forms, subscribe to newsletters, or interact with
							our services.
						</li>
						<li>
							<strong>Session Information:</strong> Information about your
							interactions with our website, including IP addresses, browser
							types, language, access times, and referring website addresses.
							This information is collected through cookies and similar
							technologies to improve our service and user experience.
						</li>
					</ul>
					...
					<p className='mb-4'>
						...
						website. You can also opt out of receiving marketing communications
						from us at any time by following the unsubscribe link or
